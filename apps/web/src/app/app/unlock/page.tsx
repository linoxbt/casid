...
export default function CreateGatePage() {
  ...
  async function submit() {
    ...
    try {
      ...
      const url = `${window.location.origin}/app/unlock/pay?${params.toString()}`;
      setLink(url);
    } catch (e) {
  ...
  return (
    <>
      <section className="hero">
        <h1>Unlock</h1>
        <p>Get paid, unlock instantly — verified by Flare, not a claim.</p>
      </section>

      <div className="grid cols-2">
        <div className="card" style={{ gridColumn: "1 / -1", maxWidth: 560 }}>
          <h2>Create a gate</h2>
          <div className="form">
            <label>
              Chain
